    ...
    return ( 
      ...
      <MDBContainer className='p-4 pb-0'>
        <section className='mb-4'>
          ...
          <a className='btn btn-outline-light btn-floating m-1' href='manishkt52@gmail.com' role='button'>
            <MDBIcon fab icon='google' />
          </a>
          <a className='btn btn-outline-light btn-floating m-1' href='https://www.instagram.com/manishkt_03/' role='button'>
            <MDBIcon fab icon='instagram' />
          </a>

          <a className='btn btn-outline-light btn-floating m-1' href='https://www.linkedin.com/in/manish-kumar-t-174787130                             ' role='button'>
            <MDBIcon fab icon='linkedin-in' />
          </a>

          <a className='btn btn-outline-light btn-floating m-1' href='https://github.com/manishkt52' role='button'>
